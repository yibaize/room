...
public class NotifyCode {
    ...
    @ExcelValue(value = "您被人提出房间")
    public static final short TO_ROOM_JACKPOT = 1519;
    ...
    public static final short DOWN_POSITION = 2004;
    ...
    @ExcelValue(value = "塞子场有人下注 返回BetUpdateDto")
    public static final short DICE_ROOM_PLAYER_BET = 2014;
    @ExcelValue(value = "骰子场结算DiceSettleRanking对象")
    public static final short DICE_ROOM_END = 2015;
    @ExcelValue(value = "骰子场停止下注")
    public static final short DICE_ROOM_NET_BET = 2016;
    @ExcelValue(value = "骰子场结束")
    public static final short TO_ROOM_END = 2017;
    @ExcelValue(value = "万人场下注倒计时")
    public static final short TO_TIMER = 2018;
