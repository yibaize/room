...
import org.zgl.rooms.three_cards.three_cards_1.dto.*;
import org.zgl.rooms.three_cards.three_cards_1.model.ForbidCompareModel;
import org.zgl.rooms.three_cards.three_cards_1.model.HandCard;
import org.zgl.rooms.type.Chip;
...
//                LoggerUtils.getLogicLog().info(moneys);
//                LoggerUtils.getLogicLog().info(p.getHandCard().getCardIds());
//                LoggerUtils.getLogicLog().info(p.getHandCard().getCardType());
